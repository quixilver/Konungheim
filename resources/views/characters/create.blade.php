...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h2 mb-0">Create New Character</h1>
            ...
            <div class="card-body">
                <form action="{{ route('characters.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                   id="title" name="title" value="{{ old('title') }}" placeholder="e.g., The Viking Warrior">
                            @error('title')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('world_current') is-invalid @enderror" 
                            ...
                            @foreach($worlds as $world)
                                <option value="{{ $world->id }}" {{ old('world_current') == $world->id ? 'selected' : '' }}>
                                    {{ $world->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Add the weapons your character uses</small>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @if($roles->count() == 0)
                            <p class="text-muted">No roles available. <a href="{{ route('roles.create') }}">Create a role first</a></p>
                        @endif
                    </div>
                    ...
                    <div class="mb-3">
                                ...
                                <div class="col-md-4 mb-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" 
                                               ...
                                               {{ in_array($perk->id, old('perks', [])) ? 'checked' : '' }}>
                        ...
                        @if($perks->count() == 0)
                            <p class="text-muted">No perks available. <a href="{{ route('perks.create') }}">Create a perk first</a></p>
                        @endif
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('objective') is-invalid @enderror" 
                                  ...
                                  placeholder="Describe your character's current objective or goal...">{{ old('objective') }}</textarea>
                        @error('objective')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('characters.index') }}" class="btn btn-secondary me-2">Cancel</a>
